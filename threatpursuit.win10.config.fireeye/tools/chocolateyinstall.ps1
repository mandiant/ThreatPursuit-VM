...
$packageName = 'threatpursuit.win10.config.fireeye'
...
### ThreatPursuit Windows 10 Cyber Threat Threatiest Intelligence VM ###
...
function prompt
{
    Write-Host "THREATPURSUIT " -ForegroundColor Green -NoNewLine
...
#### Rename the computer ####
Write-Host "[+] Renaming host to 'THREATPURSUIT'" -ForegroundColor Green
(Get-WmiObject win32_computersystem).rename("THREATPURSUIT") | Out-Null
...
Write-Host "`t[+] TP logos copied to ${Env:USERPROFILE}\Pictures" -ForegroundColor Yellow
